...
document.getElementById('contatoLink').addEventListener('click', function() {
    window.location.href = '../contact/contact.html'; // Altere '#contato' para a URL ou seção desejada
});

document.getElementById('categoriaLink').addEventListener('click', function() {
    window.location.href = '../category/category.html'; // Altere '#categoria' para a URL ou seção desejada
});

document.getElementById('quemSomosLink').addEventListener('click', function() {
    window.location.href = 'info.html'; // Altere '#quem-somos' para a URL ou seção desejada
});

document.getElementById('editAccount').addEventListener('click', function() {
    window.location.href = '../../edicao_conta/edicao_conta.html'; // Altere '#quem-somos' para a URL ou seção desejada
});